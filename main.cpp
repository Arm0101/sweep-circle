...
void test(const string &filename, int num_points) {
    ...
    if (result_file.is_open()) {
        result_file << "Numero de casos " << total_points << endl;
...
int main() {
    ...
    // };
    // input_points = {
    //     {2.53285447, 3.84225969},
    //     {3.59797378, 1.8614631},
    //     {7.16536122, 9.62074936},
    //     {5.73557985, 7.44206731},
    //     {2.7242712, 3.50210291}
    // };
    //
    // input_points = {
    //     {5.29245054, 8.72278313},
    //     {9.39477058, 2.28405143},
    //     {7.14906638, 5.05582867},
    //     {2.60532068, 8.04911486},
    //     {4.78785956, 8.54136653}
    // };
